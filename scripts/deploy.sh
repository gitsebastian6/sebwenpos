#!/usr/bin/env bash
# =============================================================================
# Ventify POS — Unified Deploy Script
# =============================================================================
...
docker run -d --name ${CONTAINER_NAME} --restart unless-stopped \
  -p ${DEFAULT_PORT}:3000 -v ventifypos-data:/app/db \
  --env-file /opt/ventifypos/.env ${DEPLOY_IMAGE}
sleep 15
...
cmd_workflow() {
  ...
  echo "═══════════════════════════════════════════"
  echo "  VentifyPOS — CI/CD Workflow Setup"
  echo "═══════════════════════════════════════════"
  echo ""
...
case "$COMMAND" in
  ...
  help|--help|-h)
    echo "Ventify POS — Unified Deploy Script"
    echo ""
