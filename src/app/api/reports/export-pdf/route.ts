...
export async function POST(req: NextRequest) {
  try {
    ...
    doc.text(storeName || 'Sebwen POS', MARGIN, MARGIN, { width: pageWidth, align: 'center' })
    ...
    doc.text(
      `Generado por Sebwen POS · ${new Date().toLocaleDateString('es-CO', { year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' })}`,
      MARGIN,
      footerY,
