...
function WelcomeHeader({ storeName }: { storeName: string }) {
  return (
    <div className="relative rounded-2xl border border-border/50 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/[0.04] via-transparent to-teal-500/[0.06] dark:from-emerald-400/[0.08] dark:via-transparent dark:to-teal-400/[0.1]" />
      {/* Decorative glow */}
      <div className="absolute -top-16 -right-16 h-32 w-32 rounded-full bg-emerald-500/[0.08] dark:bg-emerald-400/[0.06] blur-3xl" />
      <div className="absolute -bottom-8 -left-8 h-24 w-24 rounded-full bg-teal-500/[0.06] dark:bg-teal-400/[0.04] blur-3xl" />

      <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 p-5 md:p-6">
        <div>
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span className="capitalize">{formatSpanishDate()}</span>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="space-y-6">
        ...
        {/* ── WELCOME HEADER ─────────────────────────── */}
        {/* ═══════════════════════════════════════════════ */}
        <WelcomeHeader storeName={store?.name || 'Mi Tienda'} />

        {/* ═══════════════════════════════════════════════ */}
        {/* ── KPIs: VENTAS + RENTABILIDAD ────────────── */}
        {/* ═══════════════════════════════════════════════ */}
        <div className="rounded-2xl border border-border/40 p-5 md:p-6 space-y-6">
          {/* Ventas (3 KPIs) */}
          <div>
            <SectionHeader label="Ventas" />
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <KPICard
                title="Ventas Hoy"
        ...
        <div className="space-y-4">
          <SectionHeader label="Análisis de Ventas" />
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* ═══════════════════════════════════════════════ */}
        <div className="space-y-4">
          <SectionHeader label="Resumen Rápido" />
          <Card className="rounded-2xl border-border/50 bg-muted/20 dark:bg-muted/10">
            <CardContent className="p-4">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">Ticket Prom.</p>
                    <p className="text-sm font-semibold truncate">{formatCurrency(kpi.operational.avgTicketMonth, cc)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2.5">
                  <div className="h-8 w-8 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center shrink-0">
                    <Armchair className="h-3.5 w-3.5 text-amber-600 dark:text-amber-400" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">Mesas Abiertas</p>
                    <p className="text-sm font-semibold">{kpi.operational.openTablesCount}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">CxC</p>
                    <p className="text-sm font-semibold text-red-600 dark:text-red-400">{formatCurrency(kpi.operational.totalDebt, cc)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2.5">
                  <div className="h-8 w-8 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center shrink-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">Margen Mes</p>
                    <Badge className={`${kpi.profitability.month.margin >= 40 ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300' : kpi.profitability.month.margin >= 25 ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300' : 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300'} text-[10px]`}>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">Ventas Netas</p>
                    <p className="text-sm font-semibold truncate">{formatCurrency(kpi.profitability.month.netRevenue, cc)}</p>
                  </div>
                </div>
              </div>
            </CardContent>
