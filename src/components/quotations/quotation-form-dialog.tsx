...
import {
  Plus, Search, Minus, Trash2, User, CalendarDays, FileText,
  Loader2, ChevronRight, ChevronLeft, Check, ShoppingBag,
} from 'lucide-react'
...
export function QuotationFormDialog({ open, onOpenChange, store, onCreated }: QuotationFormDialogProps) {
  // Step state
