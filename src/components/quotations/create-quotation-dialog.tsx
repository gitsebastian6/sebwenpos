...
import {
  Plus, Search, Loader2, ChevronRight, ChevronLeft, Minus, Trash2, User,
  CalendarDays, FileText, Check, ShoppingBag,
} from 'lucide-react'
...
import type { ProductSearchResult, CartItem, DiscountType } from '@/components/quotations/quotation-types'
