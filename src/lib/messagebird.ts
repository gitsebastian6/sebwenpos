...
export async function getMessageBirdConfig(): Promise<MessageBirdConfig> {
  ...
  return {
    ...
    templateText: map['messagebird_template'] || `Tu código de verificación para Ventify POS es: {{code}}. Válido por ${OTP_TTL_MS / 60000} minutos. No lo compartas con nadie.`,
